...
const char* TILE_BRICK_TYPE = "BrickhoffTile";
const char* TILE_GRASS_TYPE = "GrasshoffTile";
const char* TILE_WATER_TYPE = "WaterhoffTile";
const char* TILE_FIRE_TYPE ="FirehoffTile";
const char* TILE_HARDWOOD_TYPE = "HardwoodTile";
